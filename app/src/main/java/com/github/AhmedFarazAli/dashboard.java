...
public class dashboard extends AppCompatActivity {
    ...
    private void setupListeners() {
        ...
        btn1.setOnLongClickListener(view1 -> {
            Intent i = new Intent(dashboard.this, clothes.class);
            startActivity(i);
            return true;
        });
        ...
        btn3.setOnLongClickListener(view -> {
            Intent i = new Intent(dashboard.this, music.class);
            startActivity(i);
            return true;
        });
        ...
        btn4.setOnLongClickListener(view -> {
            Intent i = new Intent(dashboard.this, Watch.class);
            startActivity(i);
            return true;
        });
        ...
        btn5.setOnLongClickListener(view -> {
            Intent i = new Intent(dashboard.this, mobile.class);
            startActivity(i);
            return true;
        });
